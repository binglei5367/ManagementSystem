				...
				try {
					...
					if (userExist != null) {
						if (userExist.changeUserInfo(newPsd)) {
							JOptionPane.showMessageDialog(ModiPsdFrame.this, "修改成功");
						} else {
							JOptionPane.showMessageDialog(ModiPsdFrame.this, "修改失败");
						}
					} else {
						JOptionPane.showMessageDialog(ModiPsdFrame.this, "密码错误", "错误", JOptionPane.ERROR_MESSAGE);
					}
